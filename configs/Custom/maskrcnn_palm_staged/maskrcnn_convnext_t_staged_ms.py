# ==========================================================================
# maskrcnn_convnext_t_staged_ms.py   (Stage D, MULTISPECTRAL arm)
# --------------------------------------------------------------------------
...
# inherited VERBATIM from maskrcnn_convnext_t_staged_full.py, so the MS and RGB
...
#          --src checkpoints/convnext_tiny_backbone_only.pth \\
#          --dst checkpoints/convnext_tiny_8band.pth --channels 8
#
...
#          --ignore-zero
#
# THE BACKBONE ARGUMENT NAME DIFFERS PER FAMILY (in_channels). Verify the built
...
_base_ = ['./maskrcnn_convnext_t_staged_full.py']
...
model = dict(backbone=dict(
    ...
    init_cfg=dict(type='Pretrained',
                  checkpoint='checkpoints/convnext_tiny_8band.pth')))
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_convnext_t_staged_ms'
