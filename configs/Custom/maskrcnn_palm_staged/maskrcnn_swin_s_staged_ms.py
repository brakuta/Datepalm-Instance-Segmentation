# ==========================================================================
# maskrcnn_swin_s_staged_ms.py   (Stage D, MULTISPECTRAL arm)
# --------------------------------------------------------------------------
...
# inherited VERBATIM from maskrcnn_swin_s_staged_full.py, so the MS and RGB
...
#          --dst checkpoints/swin_small_p4_w7_8band.pth --channels 8
#
...
_base_ = ['./maskrcnn_swin_s_staged_full.py']
...
model = dict(backbone=dict(
    ...
    init_cfg=dict(type='Pretrained',
                  checkpoint='checkpoints/swin_small_p4_w7_8band.pth')))
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_swin_s_staged_ms'
