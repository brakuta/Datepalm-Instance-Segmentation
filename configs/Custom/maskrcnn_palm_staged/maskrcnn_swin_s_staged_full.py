# ==========================================================================
# maskrcnn_palm_staged/maskrcnn_swin_s_staged_full.py   (Stage D, v4)
# --------------------------------------------------------------------------
# ARM B0 -- full training on real WV-3 30 cm from ImageNet weights.
# Architecture byte-identical to maskrcnn_swin_s_staged_ft.py; only the
# schedule base and frozen_stages differ. See the ConvNeXt-T arm-B0 config
# for the rationale. NO load_from.
# ==========================================================================
...
model = dict(
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        with_cp=False,
        frozen_stages=-1,         # arm B0: nothing frozen (mmdet Swin: -1=none)
        init_cfg=dict(
            type='Pretrained',
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_swin_s_staged_full'
