# ==========================================================================
# maskrcnn_palm_staged/maskrcnn_mambavision_s_staged_full.py   (Stage D, v4)
# --------------------------------------------------------------------------
# ARM B0 -- full training on real WV-3 30 cm from ImageNet weights.
# Architecture byte-identical to maskrcnn_mambavision_s_staged_ft.py --
# including the reduced RPN sampler/proposal caps and cudnn_benchmark=False
# (the hybrid SSM+attention graph needs both) -- and only the schedule base
# and frozen_stages differ. compute_flops stays False: the hybrid graph fails
# torch.jit.trace. See the ConvNeXt-T arm-B0 config for the rationale.
# NO load_from.
# ==========================================================================
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_mambavision_s_staged_full'
