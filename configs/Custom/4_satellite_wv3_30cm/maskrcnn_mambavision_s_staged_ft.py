# ==========================================================================
# 4_satellite_wv3_30cm/maskrcnn_mambavision_s_staged_ft.py   (Stage D, v1)
# --------------------------------------------------------------------------
...
# TITAN RTX only. Memory governed by the PROPOSAL CAP (verbatim
# Stage B/C accommodation), NOT batch 1. compute_flops=False (hybrid
# SSM+attention graph fails torch.jit.trace); cudnn_benchmark=False.
# gradient_checkpointing=False (AMP + checkpointing diverges).
# ==========================================================================
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_mambavision_s_staged_ft'
