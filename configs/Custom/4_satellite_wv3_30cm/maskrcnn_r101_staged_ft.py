# ==========================================================================
# 4_satellite_wv3_30cm/maskrcnn_r101_staged_ft.py   (Stage D, v1)
# --------------------------------------------------------------------------
...
# Portable. ResNet native -> runtime imports/hooks inherited.
# ==========================================================================
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_r101_staged_ft'
