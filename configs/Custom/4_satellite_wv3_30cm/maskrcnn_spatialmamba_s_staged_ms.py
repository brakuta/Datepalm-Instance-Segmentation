# ==========================================================================
# maskrcnn_spatialmamba_s_staged_ms.py   (Stage D, MULTISPECTRAL arm)
# --------------------------------------------------------------------------
...
# inherited VERBATIM from maskrcnn_spatialmamba_s_staged_full.py, so the MS and RGB
...
#          --src /workspace/mmdetection/checkpoints/spatialmamba/spatialmamba_small_in1k.pth \\
#          --dst /workspace/mmdetection/checkpoints/spatialmamba/spatialmamba_small_8band.pth \\
#          --channels 8
#
...
_base_ = ['./maskrcnn_spatialmamba_s_staged_full.py']
...
model = dict(backbone=dict(
    in_chans=N_BANDS,
    pretrained='/workspace/mmdetection/checkpoints/spatialmamba/'
               'spatialmamba_small_8band.pth'))
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_spatialmamba_s_staged_ms'
