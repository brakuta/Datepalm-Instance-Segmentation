# ==========================================================================
# 4_satellite_wv3_30cm/maskrcnn_convnext_t_staged_ft.py   (Stage D, v1)
# --------------------------------------------------------------------------
...
# Portable. Relative checkpoint path resolved against launch cwd:
#   ls checkpoints/convnext_tiny_backbone_only.pth
# FPN neck verbatim (no add_extra_convs -- P6 via max-pool, the
# documented Stage A/B divergence preserved for comparability).
# ==========================================================================
...
work_dir = '/workspace/mmdetection/work_dirs/Stage_D/maskrcnn_convnext_t_staged_ft'
